...
// ============================================
const GOOGLE_SHEETS_URL = 'https://script.google.com/macros/s/AKfycbx7XAlWT_91m9knFcMUW2n_Ou63qYgrwirwxFb4mBnDy6hkprKxQPAYby-eYiYkYi42/exec';
        ...
        setTimeout(() => {
            ...
            if (isValidAdmin && isCorrectPassword) {
                ...
                setTimeout(() => {
                    ...
                    window.location.href = '/Home/AdminPage'; // Update with your route
                }, 1500);
